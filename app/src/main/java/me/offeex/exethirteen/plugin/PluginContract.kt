...
object PluginContract {
     ...
     *
     * Constant Value: "me.offeex.exethirteen.plugin.ACTION_NATIVE_PLUGIN"
     */
    const val ACTION_NATIVE_PLUGIN = "me.offeex.exethirteen.plugin.ACTION_NATIVE_PLUGIN"

    /**
     * Activity Action: Used for ConfigurationActivity.
     *
     * Constant Value: "me.offeex.exethirteen.plugin.ACTION_CONFIGURE"
     */
    const val ACTION_CONFIGURE = "me.offeex.exethirteen.plugin.ACTION_CONFIGURE"
    /**
     * Activity Action: Used for HelpActivity or HelpCallback.
     *
     * Constant Value: "me.offeex.exethirteen.plugin.ACTION_HELP"
     */
    const val ACTION_HELP = "me.offeex.exethirteen.plugin.ACTION_HELP"

    /**
     * The lookup key for a string that provides the plugin entry binary.
     *
     * Example: "/data/data/me.offeex.exethirteen.plugin.obfs_local/lib/libobfs-local.so"
     *
     * Constant Value: "me.offeex.exethirteen.plugin.EXTRA_ENTRY"
     */
    const val EXTRA_ENTRY = "me.offeex.exethirteen.plugin.EXTRA_ENTRY"
    /**
     * The lookup key for a string that provides the options as a string.
     *
     * Example: "obfs=http;obfs-host=www.baidu.com"
     *
     * Constant Value: "me.offeex.exethirteen.plugin.EXTRA_OPTIONS"
     */
    const val EXTRA_OPTIONS = "me.offeex.exethirteen.plugin.EXTRA_OPTIONS"
    /**
     ...
     *
     * Constant Value: "me.offeex.exethirteen.plugin.EXTRA_HELP_MESSAGE"
    </host_name> */
    const val EXTRA_HELP_MESSAGE = "me.offeex.exethirteen.plugin.EXTRA_HELP_MESSAGE"

    /**
     * The metadata key to retrieve plugin version. Required for plugin applications.
     *
     * Constant Value: "me.offeex.exethirteen.plugin.version"
     */
    const val METADATA_KEY_VERSION = "me.offeex.exethirteen.plugin.version"

    /**
     * The metadata key to retrieve plugin id. Required for plugins.
     *
     * Constant Value: "me.offeex.exethirteen.plugin.id"
     */
    const val METADATA_KEY_ID = "me.offeex.exethirteen.plugin.id"
    /**
     ...
     *
     * Constant Value: "me.offeex.exethirteen.plugin.id.aliases"
     */
    const val METADATA_KEY_ID_ALIASES = "me.offeex.exethirteen.plugin.id.aliases"
    /**
     * The metadata key to retrieve default configuration. Default value is empty.
     *
     * Constant Value: "me.offeex.exethirteen.plugin.default_config"
     */
    const val METADATA_KEY_DEFAULT_CONFIG = "me.offeex.exethirteen.plugin.default_config"
    /**
     ...
     *
     * Constant Value: "me.offeex.exethirteen.plugin.executable_path"
     */
    const val METADATA_KEY_EXECUTABLE_PATH = "me.offeex.exethirteen.plugin.executable_path"
