 ...
 *    &lt;application&gt;
 *        ...
 *        &lt;provider android:name="me.offeex.exethirteen.$PLUGIN_ID.BinaryProvider"
 *                     android:authorities="me.offeex.exethirteen.plugin.$PLUGIN_ID.BinaryProvider"&gt;
 *            &lt;intent-filter&gt;
 *                &lt;category android:name="me.offeex.exethirteen.plugin.ACTION_NATIVE_PLUGIN" /&gt;
 *            &lt;/intent-filter&gt;
 *        &lt;/provider&gt;
 *        ...
 *    &lt;/application&gt;
