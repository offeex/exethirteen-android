...
import me.offeex.exethirteen.plugin.PluginManager.loadString
...
abstract class ResolvedPlugin(protected val resolveInfo: ResolveInfo) : Plugin() {
    ...
    override val idAliases: Array<String> by lazy {
        when (val value = componentInfo.metaData.get(PluginContract.METADATA_KEY_ID_ALIASES)) {
            ...
            is Int -> Core.app.packageManager.getResourcesForApplication(componentInfo.applicationInfo).run {
    ...
    override val label: CharSequence get() = resolveInfo.loadLabel(Core.app.packageManager)
    override val icon: Drawable get() = resolveInfo.loadIcon(Core.app.packageManager)
